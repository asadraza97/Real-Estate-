    ...
    >
      ...
      <div className=" flex flex-col md:flex-row items-center md:items-start md:gap-20">
        ...
        <div className=" flex flex-col items-center md:items-start mt-10 text-gray-600">
          ...
          <p className=" my-10 max-w-full"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas id amet dolorem. Commodi aut incidunt quo, vitae quae eaque placeat soluta.</p>
